  ...
  return (
    <div className="w-full py-16 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <Link href="/services" className="block text-center mt-8 md:mt-12">
          <Button
            size="lg"
            className="mx-auto bg-orange-400 hover:bg-orange-500 transition-colors px-8 py-6 text-lg w-full md:w-auto"
          >
            View All Services
          </Button>
        </Link>
